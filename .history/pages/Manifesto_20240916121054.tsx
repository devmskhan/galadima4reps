    ...
    return (
      ...
      <section className="hero-section bg-emerald-500 text-gray-300 py-20 px-6 bg-cover bg-center" style={{ backgroundImage: "url('/udr1.jpeg')" }}>
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg mb-6">Transforming Kumbotso Local Government for a brighter future. As your dedicated representative, i pledge to address the pressi</p>
        </div>
      </section>
