      ...
      <section className="policies-section py-12 px-6">
        <div className="container mx-auto">
          ...
          <div className="policy bg-gray-100 p-6 mb-8 rounded-md shadow-md">
            ...
            <p cla>Our infrastructure policy will prioritize the development of roads, bridges, and public transportation systems to enhance connectivity and spur economic growth.</p>
            <ul className="list-disc list-inside mt-4">
