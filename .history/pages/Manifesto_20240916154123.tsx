      ...
      <section className="policies-section py-12 px-6">
        <div className="container mx-auto">
          ...
          <div className="policy bg-gray-100 p-6 mb-8 rounded-md shadow-md">
            ...
            <p className="">Education is the foundation of our future. We are committed to investing in schools, modernizing curriculum, and ensuring that every child has access to quality education.</p>
            <ul className="list-disc list-inside mt-4">
