      ...
      <section className="policies-section py-12 px-6">
        <div className="container mx-auto">
          ...
          <div className="bg-gray-500">
            <h3>
                Together, let us build a prosperous, sustainable and equitable Kumbotso Local Government for all. Vote for me to drive positive change and a brighter fut
            </h3>
