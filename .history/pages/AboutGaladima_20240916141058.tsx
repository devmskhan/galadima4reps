...
function AboutGaladima() {
    return (
      ...
      style={{ backgroundImage: "url('/https://www.thecable.ng/wp-content/uploads/2022/12/20221205_182145.jpg')" }} // Add your background image path here
    >
      <div className="bg-white bg-opacity-70 p-8 rounded-lg shadow-lg max-w-3xl text-center">
        <div className="flex flex-col items-center">
          <Image
            src="/aminu-ibrahim-yusuf.jpg" // Replace with the path to the politician's image
