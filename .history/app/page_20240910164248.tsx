    ...
    <div className="container mx-auto flex justify-between items-center">
      ...
      <nav>
        <ul className="flex space-x-4">
          ...
          <li><a href="#" className="text-gray-600 hover:text-gray-700">Agenda</a></li>
          <li><a href="#" className="text-gray-600 hover:text-gray-700">News</a></li>
          <li><a href="#" className="text-gray-600hover:text-gray-700">Contact</a></li>
        </ul>
      </nav>
    </div>
  </header>
