...
export default function Home() {
  ...
  <div className="container mx-auto flex justify-between items-center">
    <div className="flex items-center space-x-3">
      <img src="/logo.pg" alt="Logo" className="h-10 w-10" />
  ...
  <section className="relative h-[500px] bg-cover bg-center" style={{ backgroundImage: "url('/1st.jpg')" }}>
    <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="text-center text-white">
        <h2 className="text-4xl font-bold mb-4">Join the Movement</h2>
        <p className="text-lg mb-8">For the development Kumbotso Local Government</p>
        <a href="#" className="bg-red-600 text-white py-2 px-4 rounded hover:bg-red-500">Federal House of Representative Insha Allah</a>
      </div>
    </div>
  </section>
