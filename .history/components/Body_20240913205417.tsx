...
function Body() {
  ...
  <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col sm:flex-row items-center w-full">
    ...
    <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
      <a href="#" className="text-lime-500 font-bold mb-3 py-2 px-4 rounded hover:bg-red-500">
        Federal House of Representatives Insha Allah
      </a>
    </div>

    {/* Full text - Hidden on small screens */}
    <div className="w-full sm:w-1/2 flex items-center justify-start sm:pl-16 pl-6 sm:mt-0 mt-8 hidde sm:block">
    ...
    <div className="w-full sm:w-1/2 flex items-center justify-center mt-4 sm:mt-0">
      <img src="/top.png" alt="Movement Image" className="h-full object-cover sm:mt-2 mt-[-20px] " />
    </div>
  </div>
</section>
...
<main className="container mx-auto py-12">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div className="manifesto-page">
      <section className="hero-section bg-blue-800 text-white py-20 px-6">
        <div className="container mx-auto text-center">
