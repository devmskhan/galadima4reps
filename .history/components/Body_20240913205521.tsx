...
function Body() {
  ...
  <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col sm:flex-row items-center w-full">
    ...
    <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
      <a href="#" className="text-lime-500 font-bold mb-3 py-2 px-4 rounded ">
        Federal House of Representatives Insha Allah
      </a>
    </div>

    {/* Full text - Hidden on small screens */}
    <div className="w-full sm:w-1/2 flex items-center justify-start sm:pl-16 pl-6 sm:mt-2 mt-8 hidden sm:block">
