...
function Body() {
  ...
  <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col sm:flex-row items-center w-full">
    ...
    <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
      <a href="#" className="text-emerald-600 font-bold mb-3 py-2 px-4 rounded ">
...
<main className="container mx-auto py-12">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div className="manifesto-page">
      <section className="hero-section bg-emerald-500 text-gray-300 py-20 px-6" style={{ backgroundImage: "url('/udr1.jpeg')" }}>
        <div className="container mx-auto text-center">
