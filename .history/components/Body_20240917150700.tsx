...
>
  <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col sm:flex-row items-center w-full">
    ...
    <Link href="/Donatio" className="bg-red-600 text-white font-bold py-2 px-6 rounded-full mt-4 inline-block hover:bg-red-700 transition duration-300">Donate</Link>
