...
function Header() {
    return (
      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="bg-emerald-100 py-4">
      <Marquee speed={50} gradient={false}>
        <div className="flex items-center">
          ...
          <Link href="/about" className="text-blue-600 font-semibold underline ml-6 text-sm">Read More
            <a className="text-blue-600 font-semibold underline ml-6 text-sm">
              Read More
            </a>
          </Link>
        </div>
